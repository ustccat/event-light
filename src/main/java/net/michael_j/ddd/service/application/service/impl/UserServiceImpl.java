...
import net.michael_j.ddd.service.core.user.event.LogoutEvent;
import net.michael_j.ddd.service.core.user.event.UserEvent;
import net.michael_j.ddd.service.core.user.event.UserEventPublisher;
import net.michael_j.ddd.service.core.user.event.UserEventType;
...
public class UserServiceImpl implements ApplicationContextAware {
    ...
    @Autowired
    public UserServiceImpl(UserEventPublisher userEventPublisher) {
